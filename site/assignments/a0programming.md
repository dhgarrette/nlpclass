...
For an example of this setup, see the program [`Example`](https://github.com/dhgarrette/nlpclass/blob/master/src/main/scala/nlpclass/Example.scala), which is set up in a similar way (though with a different package name).  It can be run as:
...
In the `nlpclass-fall2013` jar that your project should have as a dependency, there is a trait [`nlpclass.NGramCountingToImplement`](https://github.com/dhgarrette/nlpclass/blob/master/src/main/scala/nlpclass/AssignmentTraits.scala#L6).  It looks like this:

...
Your task is to implement the traits provided in [AssignmentTraits.scala](https://github.com/dhgarrette/nlpclass/blob/master/src/main/scala/nlpclass/AssignmentTraits.scala):

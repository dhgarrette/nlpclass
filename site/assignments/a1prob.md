...
The source code for the traits can be [viewed](https://github.com/dhgarrette/nlpclass/blob/master/src/main/scala/nlpclass/AssignmentTraits.scala#L21) in the class GitHub repository.
